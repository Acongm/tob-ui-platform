...
export const components: ComponentMeta[] = [
  ...
  },
  {
    ...
    status: 'planned',
    category: 'data-entry',
    description: '计划通过 ui-bridge 适配 AntD Form，业务代码不直接依赖 antd Form。',
    replaces: ['antd/Form'],
    allowedImport: '@tob-ui/ui-bridge',
    forbiddenImports: [{ from: 'antd', names: ['Form'], reason: '表单能力需要统一 schema、校验、布局和提交状态。' }],
    aiGuidance: ['不要直接使用 antd Form。', '表单页面优先等待 Form/ModalForm recipe。']
  },
  {
    name: 'Modal',
    packageName: '@tob-ui/ui-bridge',
    ...
    status: 'planned',
    category: 'feedback',
    description: '计划通过 ui-bridge 适配 AntD Modal，统一弹窗尺寸、footer、loading 和关闭行为。',
    replaces: ['antd/Modal', '@material-ui/core/Dialog'],
    allowedImport: '@tob-ui/ui-bridge',
    forbiddenImports: [
      { from: 'antd', names: ['Modal'], reason: '弹窗交互需要统一。' },
      { from: '@material-ui/core', names: ['Dialog'], reason: 'MUI v4 Dialog 属于 legacy，不允许新代码使用。' }
    ],
    aiGuidance: ['新增/编辑弹窗后续优先使用 ModalForm。', '不要手写 Modal + Form 的组合。']
  }
];
